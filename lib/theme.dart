...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff566423),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xffd9eb9a),
      onTertiaryContainer: Color(0xff3e4c0b),
      ...
      tertiaryFixed: Color(0xffd9eb9a),
      onTertiaryFixed: Color(0xff171e00),
      tertiaryFixedDim: Color(0xffbdce80),
      onTertiaryFixedVariant: Color(0xff3e4c0b),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff647330),
      ...
      tertiaryFixed: Color(0xff647330),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff4c5a1a),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff263000),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff414f0e),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff414f0e),
      onTertiaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffbdce80),
      onTertiary: Color(0xff293500),
      tertiaryContainer: Color(0xff3e4c0b),
      onTertiaryContainer: Color(0xffd9eb9a),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffd2e594),
      onTertiary: Color(0xff202900),
      tertiaryContainer: Color(0xff879850),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffe6f8a6),
      onTertiary: Color(0xff000000),
      tertiaryContainer: Color(0xffb9ca7d),
